...
public interface ServicioDatosInterface extends Remote {
	...
	/**
	 *
	 * Devuelve la lista de nicks de los seguidores actualmente logeados de un usuario
	 *
	 * @param nick el nick del usuario de quien se quieren obtener los seguidores
	 * @return la lista de nicks de los seguidores actualmente logeados de un usuario
	 * @throws RemoteException
	 */
	public List<String> listarSeguidoresLogeados(String nick) throws RemoteException;

	/**
	 * Devuelve la lista de nicks de los seguidores actualmente NO logeados de un usuario
	 *
	 * @param nick el nick del usuario de quien se quieren obtener los seguidores
	 * @return la lista de nicks de los seguidores actualmente NO logeados de un usuario
	 * @throws RemoteException
	 */
